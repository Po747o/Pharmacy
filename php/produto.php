    ...
    <header class="cabecalho">
        <div class="titulo">
            ...
            <form action="../php/carrinho.php" method="post">
                ...
                <button type="submit" class="btn btnVermelho containerCarrinho"
                    style="position: relative; right: 0; z-index: 2; margin-top: -60px; background-color: none;"><span
                        class="material-symbols-outlined">shopping_cart_checkout</span></button>
            </form>
        </div>
    </header>
    <nav class="topnav">
